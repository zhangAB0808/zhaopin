...
<div class="main">
    <div class="headerInfo">
        ...
        <div class="op1">
            <div class="salary">
                <strong>${requestScope.companyJobVO.job.jobMinSalary}-${requestScope.companyJobVO.job.jobMaxSalary}/月</strong>
            </div>
            <div class="shoucang">
                <img class="icon" alt="" src="${pageContext.request.contextPath}/images/zw_images/shoucang.svg">
                <a href="javascript:collect(${id})">收藏</a>
            </div>
    ...
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <a href="#" onclick="resumeDeliveryApplySubmitBtn(${requestScope.companyJobVO.job.jobId})"
                   class="btn btn-primary" data-dismiss="modal">确认</a>
